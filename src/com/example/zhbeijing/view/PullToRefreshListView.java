...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void initHeaderView() {
		mHeaderView = View
				.inflate(getContext(), R.layout.lv_pull_refresh, null);
		this.addHeaderView(mHeaderView);

		tvTitle = (TextView) mHeaderView.findViewById(R.id.tv_refresh_hint);
		tvTime = (TextView) mHeaderView.findViewById(R.id.tv_refresh_time);
		ivArrow = (ImageView) mHeaderView.findViewById(R.id.iv_refresh_row);
	...
	private void initFooterView() {
		mFooterView = View.inflate(getContext(), R.layout.list_item_footer,
				null);
